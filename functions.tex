...
\input{func/functions-concept.tex}

\section{Primeiras Definições}


\input{func/functions-definitions.tex}

\section{Funções Injetiva, Sobrejetiva e Bijetiva}

\input{func/functions-sib.tex}

\section{Funções e Subconjuntos do Domínio}

\input{func/functions-subsets.tex}

\section{Lógica de Segunda ou Mais Alta Ordem}

\input{func/functions-higher.tex}

\section{Funções e Relações}

\input{func/functions-relations.tex}

\section{Exercícios}

\input{func/functions-exercises.tex}

\section{Gabarito}

\input{func/functions-feedback.tex}