...
\begin{itemize}
    ...
    \item Existe um fórum\footnote{Forum: leanprover.zulipchat.com/login/} ativo sobre Lean, onde dúvidas ou discussões são frequentes. Há ainda uma página\footnote{novos-mebros: leanprover.zulipchat.com/login/#narrow/stream/113489-new-members} para novos membros.
\end{itemize}
