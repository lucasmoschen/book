...
Lean implementa o chamado \textit{calculus of constructions}, ou cálculo de contruções, um sistema dedutivo bastante poderoso, que 
consegue codificar lógicas, como as futuramente discutidas lógica proposicional e lógica de primeira ordem, com o respaldo da teoria que une lógica e teoria dos tipos, o isomorfismo de Curry-Howard.
